<nav>
    ...
    <div class="nav-menu">
        ...
        <a href="peserta_dashboard"><button
                class="nav-btn<?= (isset($_GET['page']) && $_GET['page'] == 'peserta_dashboard') ? ' active' : ''; ?>">Home</button></a>
        <a href=""><button
                class="nav-btn<?= (isset($_GET['page']) && $_GET['page'] == '') ? ' active' : ''; ?>">Alur</button></a>
        <a href=""><button
                class="nav-btn<?= (isset($_GET['page']) && $_GET['page'] == '') ? ' active' : ''; ?>">Kegiatan</button></a>
    </div>
