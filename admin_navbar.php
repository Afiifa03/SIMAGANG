<nav>
        ...
        <div class="nav-menu">
            <a href="dashboard_umum.php"><button class="nav-btn<?php echo basename($_SERVER['PHP_SELF'])=='dashboard_umum.php'?' active':''; ?>">Dashboard</button></a>
            <a href="admin_dashboard.php"><button class="nav-btn<?php echo basename($_SERVER['PHP_SELF'])=='admin_dashboard.php'?' active':''; ?>">Home</button></a>
